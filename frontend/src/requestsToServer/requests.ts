import { GameRequest, PostGameRequest, PutGameRequest } from '../types/GameRequest'
...
export const createGameRequest = async (gameRequest :PostGameRequest) :Promise<GameRequest> => {
    await wait(1000);
    return {
            ...gameRequest,
...
export const changeGameRequest = async (gameRequest :PutGameRequest) :Promise<GameRequest> => {
    await wait(1000);
    return {
            ...gameRequest,
            status: 'active',
